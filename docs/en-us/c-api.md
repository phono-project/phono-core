...
ime_demo_capi provides a real-time terminal UI through the same C ABI. It supports insertion, backspace/delete, left/right cursor movement, automatic segmentation, committed history, numbered candidate selection, and immediate Ctrl-C cancellation.
